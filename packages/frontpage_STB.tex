...
\begin{titlepage}
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
            ...
            \multicolumn{3}{|c|}{\includegraphics[width=0.4\textwidth]{ressources-graphiques/logos/logo_simonin.png}} \\  % Second row with height set to 3 cm
            \hline
            \hline
            ...
            \hline
            \hline
            \multicolumn{2}{|c|}{\rule{0pt}{3cm}\fontsize{16}{40}\selectfont \titreprojet} & \multirow{3}{*}{\includegraphics[width=\linewidth, width=3cm, keepaspectratio]{input_data/image_projet_page_de_garde.png}} \\
